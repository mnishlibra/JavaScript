...
router.post('/add-user-to-company/:id',companyController.addUserToCompany)
router.delete('/remove-users-from-company/:id',companyController.removeUserFromCompany)
